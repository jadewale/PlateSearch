...
class RegisterForm extends React.Component {
  ...
  componentDidMount() {
    ...
    onChangeFields = (evt) => {
      const object = this.state.fields;
          ...
          <div className="box box-info">
            ...
            <form className="form-horizontal">
              <div className="box-body">
                ...
                <div className="form-group">
                  <label htmlFor="inputPassword3" className="col-sm-2 control-label">License Plate</label>
                ...
                <div className="form-group">
                  <label htmlFor="inputPassword3" className="col-sm-2 control-label">Car Model</label>
                ...
                <div className="form-group">
                  <label htmlFor="inputPassword3" className="col-sm-2 control-label">Upload</label>
